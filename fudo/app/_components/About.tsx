...
const About = () => {
  return (
    <main className="mx-auto mt-52 flex max-w-7xl flex-col items-start justify-center lg:flex-row">
      ...
      <section>
        <div data-aos="fade-up" data-aos-delay="400" className="mx-auto text-center mt-5 lg:m-0">
          <Subtext>O QUE ELES DIZEM</Subtext>
        </div>
        <h1 data-aos="fade-up" data-aos-delay="1000"  className="mb-20 mt-5 text-2xl lg:text-5xl max-w-80 lg:max-w-3xl font-bold text-gray-900 mx-auto">
          O Que Nossos Clientes Dizem Sobre Nós
        </h1>
        <p data-aos="fade-up" data-aos-delay="1200" className="text-xl font-medium text-gray-500 mx-5 ml-9">
        ...
        <div data-aos="fade-up" data-aos-delay="1500" className="mt-10 flex items-center gap-5 justify-center lg:justify-start">
          <Image
